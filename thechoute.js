...
case 'sticker':
                        ...
                        await leo.sendMessage(from,  fs.readFileSync(ran), sticker, {quoted: choute, contextInfo: { mentionedJid: [sender]}});
                        fs.unlinkSync(media);
                        fs.unlinkSync(ran);})
...
//case 'a':
  ...
  //𝐋𝐢𝐬𝐭𝐚 𝐝𝐞 𝐌𝐞𝐧𝐮𝐬´
                ...
                {buttonId:`IM4K`,buttonText:{displayText: 'Como ser un bot'},type:1}]
                    ...
                    buttonsMessage = {
                    contentText: `${txtt}`,
                    footerText: '© edit 𝕿𝖚𝖙𝖞', imageMessage: imageMsg,
                    buttons: buttons1,
                    headerType: 4}
                    all = leo.prepareMessageFromContent(from, { buttonsMessage }, { quoted: choute, contextInfo: { mentionedJid: [sender,ownerNumber]} })
                    leo.relayWAMessage(all)
...
case 'nuevo':
  fansh = leo.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 0, "totalAmount1000" : '1000', "message": `${nuevo}\n\n\n 𝓹𝓪𝓷𝓺𝓾𝓮𝓺𝓾𝓮`, "footerText": "*𝕿𝖍ٌ𝖊𝕮𝖍𝖔𝖚𝖙𝖊*", "thumbnail":  fs.readFileSync('./media/imagen/Faketumber.jpg'), "surface": 'CATALOG', "orderTitle": 'Sexo'}}, {contextInfo: { mentionedJid: [sender]}, quoted:choute, })
  leo.relayWAMessage(fansh)
  break
//════════════════════════════════════════ LOGOS ════════════════════════════════
